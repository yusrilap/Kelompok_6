...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center mb-4 mt-4">
            {{ config('app.name', 'SIPG') }} - Sistem Abensi Karyawan & Dosen
            <br>
            <span style="font-weight: bold">( Kelompok 6 - APPS )</span>
        </div>
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-footer text-center text-secondary">
                    Powered by <a href="#" class="font-weight-bold text-secondary" target="_blank">Kelompok 6</a>.
                </div>
            </div>
        </div>
    </div>
